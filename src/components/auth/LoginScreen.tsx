        ...
        {showQR ? (
          ...
          <div className="glass-card rounded-r3 p-8 border border-stroke text-center">
            ...
            <div className="flex items-center gap-2 justify-center text-text-tertiary mb-6">
              ...
              <span className="text-caption">End-to-end encrypted handshake</span>
            </div>
          ...
          /* Credential Login */
          <form onSubmit={handleSubmit} className="glass-card rounded-r3 p-8 border border-stroke space-y-5">
            ...
            <div className="flex justify-between items-center">
              ...
              <button type="button" className="text-caption text-primary hover:underline">Reset access key</button>
            </div>
