export const FEATURE_FLAG_PREFIX = "cap.";
...
export function negotiateCapabilities(localSupported, remoteAdvertised, remoteRequired) {
    const localSet = new Set(localSupported);
    const accepted = new Set();
    const ignoredRemote = new Set();
...
export function negotiateConversationSecurityMode(localPreferred, remoteOffered) {
