...
export const MOCK_MESSAGES: Message[] = [
  { id: 'm1', userId: 'u1', content: 'System diagnostic complete. All grids are operating at 98% efficiency. We detected a minor fluctuation in Sector 7, but the automated protocols handled it.', timestamp: '09:15 AM', pinned: true },
  { id: 'm2', userId: 'u3', content: 'Has anyone else noticed the latency spike on the western node? It\'s been drifting by about 40ms for the last hour.', timestamp: '09:22 AM' },
  { id: 'm3', userId: 'u2', content: 'Checking logs now... I see it. Looks like a routing loop in the legacy subnet. I\'ll flush the cache and restart the daemon.', timestamp: '09:24 AM', reactions: [{ emoji: '👀', count: 1, reacted: false }] },
  { id: 'm4', userId: 'u2', content: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.', timestamp: '09:25 AM' },
  { id: 'm5', userId: 'me', content: 'Thanks Glitch. Let me know if you need authorization for the restart.', timestamp: '09:28 AM', replyToId: 'm3' },
  { id: 'm6', userId: 'u4', content: 'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', timestamp: '09:45 AM' },
  { id: 'm7', userId: 'u1', content: 'Just a reminder that the weekly sync is pushed to 14:00 UTC. We need to discuss the new encryption standards for the external gateway.', timestamp: '10:05 AM', reactions: [{ emoji: '👍', count: 3, reacted: true }] },
  { id: 'm8', userId: 'u3', content: 'Got it. I\'ll have the report ready by then. Also, did you see the new neural interface prototype? It\'s wild.', timestamp: '10:12 AM' },
  { id: 'm9', userId: 'me', content: 'Yeah, I saw the specs. The bandwidth is impressive but the thermal output is concerning. We don\'t want to fry anyone\'s cortex.', timestamp: '10:15 AM', reactions: [{ emoji: '🔥', count: 2, reacted: true }], replyToId: 'm8' },
