export const MULTISTREAM_NAMESPACE = "/aether";
export function stringifyProtocolId(protocol) {
    return `${MULTISTREAM_NAMESPACE}/${protocol.family.toLowerCase()}/${protocol.version.major}.${protocol.version.minor}`;
}
export function parseProtocolId(input) {
...
function parseVersionPart(value, label) {
    if (!value) {
